...
public class NoJobStudentDaoImpl implements NoJobStudentDao {
	...
	public List<StudentDTO> listNoJobStudentAll() {
		...
		String hql = " select new com.stuinfo.domain.DTO.StudentDTO(stuinfoStuBaseinfo,stuinfoStuGrade,stuinfoStuClass) "
				...
				+ " and stuinfoStuClass.stu_grade_id=stuinfoStuGrade.stu_grade_id and stuinfoStuBaseinfo.stu_status='5' ";
