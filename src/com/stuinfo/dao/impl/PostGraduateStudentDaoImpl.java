...
public class PostGraduateStudentDaoImpl implements PostGraduateStudentDao {
	...
	public List<StudentDTO> listPostGraduateStudentAll() {
		...
		String hql = " select new com.stuinfo.domain.DTO.StudentDTO(stuinfoStuBaseinfo,stuinfoStuGrade,stuinfoStuClass) "
				...
				+ " and stuinfoStuClass.stu_grade_id=stuinfoStuGrade.stu_grade_id and stuinfoStuBaseinfo.stu_status='2' ";
