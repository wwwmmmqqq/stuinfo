...
<body>
						...
						<div class="col-md-12">
							<div class="panel panel-white" id="js-alerts">
								<div class="panel-heading clearfix">
									<h4 class="panel-title">未就职学生信息</h4>
								</div>
								<div class="panel-body">
									<table class="table table-hover" id="nojob_student_table">
										<thead>
											<tr>
												<th>#</th>
												<th>学号</th>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myLargeModalLabel">未就职学生信息</h4>
					</div>
					<div class="modal-body">
						<div id="main_body">
							<table class="modal_nojob_student_table" id="modal_nojob_student_table">
								<tbody>
									<tr>
										<td>学号：</td>
	...
	<script type="text/javascript">
		window.onload = function() {
			GetAllNoJobStudentByPageAndSearch(1);
			 Get_Student_Class(); 
				NoticeRedPoint();
		}
		function time(){
...
laydate(end);
	...
	<script src="<%=basePath%>js/NoJobStudent/GetAllNoJobStudent.js"></script>
	<script src="<%=basePath%>js/NoJobStudent/DetailNoJobStudent.js"></script>
	<script src="<%=basePath%>js/NoJobStudent/UpdateNoJobStudent.js"></script>
	<script src="<%=basePath%>js/NoJobStudent/DeleteNoJobStudent.js"></script>
