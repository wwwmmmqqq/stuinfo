						...
						<div class="col-md-12">
							<div class="panel panel-white" id="js-alerts">
								<div class="panel-heading clearfix">
									<h4 class="panel-title">考研学生信息</h4>
								</div>
								<div class="panel-body">
									<table class="table table-hover " id="postgraduate_student_table">
										<thead>
											<tr>
												<th>#</th>
												<th>学号</th>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myLargeModalLabel">考研学生信息</h4>
					</div>
					<div class="modal-body">
						<div id="main_body">
							<table class="modal_postgraduate_student_table" id="modal_postgraduate_student_table">
								<tbody>
									<tr>
										<td>学号：</td>
...
laydate(end);
	...
	<script src="<%=basePath%>js/PostGraduateStudent/GetAllPostGraStudent.js"></script>
	<script src="<%=basePath%>js/PostGraduateStudent/DetailPostGraStudent.js"></script>
	<script src="<%=basePath%>js/PostGraduateStudent/UpdatePostGraStudent.js"></script>
