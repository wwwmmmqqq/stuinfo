...
/* 修改个学生信息 */
function UpdateNoJobStudent(thisStudentInfo) {
	var jc = $
			.confirm({
				...
				buttons : {
					'提交修改' : {
						...
						action : function() {
							...
							xhr
									.open("POST",
											"/stuinfo/noJobStudent/UpdateNoJobStudentById");
				...
				onContentReady : function() {
							...
							if (xhr.status == 200) {
								...
								if (noJObStudentById[0].stuinfoStuBaseinfo.stu_id == thisStudentInfo.id) {
									...
									new_tr_1.innerHTML = '<td>学号：</td>'
											...
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_account
											+ '"></td>'
											+ '<td><input class="form-control  " type="hidden" id="stu_id_modify"  value="'
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_id
											+ '"></td>'
									...
									new_tr_1.innerHTML = '<td>姓名：</td>'
											...
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_name
											+ '"></td>'
											+ '<td>照片：</td>'
											+ '<input class="form-control  " id="stu_photo_modify" type="text" value="'
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_photo
											+ '" >'
									...
									new_tr_1.innerHTML = '<td>性别：</td>'
											...
											+ '<option value="'
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_sex
											...
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_adress
											+ '" ></td>'
									var select = document
									...
									new_tr_1.innerHTML = '<td>出生年月：</td>'
											...
											+ '<option value="'
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_familytype
									...
									new_tr_1.innerHTML = '<td>民族：</td>'
											...
											+ '<option value="'
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_policits
									...
									new_tr_1.innerHTML = '<td>证件号码：</td>'
											...
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_idcard
											+ '"></td>'
											+ '<td>本人联系电话：</td>'
											+ '<input class="form-control  " id="stu_phenumber_modify" type="text" value="'
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_phenumber
											+ '" >'
									...
									new_tr_1.innerHTML = '<td>父亲姓名：</td>'
											...
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_fathername
											+ '"></td>'
											+ '<td>父亲联系电话：</td>'
											+ '<input class="form-control  " id="stu_fathernum_modify" type="text" value="'
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_fathernum
											+ '" >'
									...
									new_tr_1.innerHTML = '<td>母亲姓名：</td>'
											...
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_mothername
											+ '"></td>'
											+ '<td>母亲联系电话：</td>'
											+ '<input class="form-control  " id="stu_mothernum_modify" type="text" value="'
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_mothernum
											+ '" >'
									...
									new_tr_1.innerHTML = '<td>层次：</td>'
											...
											+ '<option value="'
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_lev
											...
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_college
											+ '" ></td>'
									var select = document
									...
									new_tr_1.innerHTML = '<td>学院：</td>'
											...
											+ '<option value="'
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_major
									...
									for (var num1 = 0; num1 < classList.length; num1++) {
										...
										if (option.value == noJObStudentById[0].stuinfoStuGrade.stu_grade_id) {
										...
										if (option.value == noJObStudentById[0].stuinfoStuGrade.stu_class_id) {
											option.selected = "selected";
										}
									}
									...
									new_tr_1.innerHTML = '<td>学制：</td>'
											...
											+ '<option value="'
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_year
											...
											+ noJObStudentById[0].stuinfoStuBaseinfo.stu_change
											+ '" ></td>'
					...
					xhr.open("POST",
							"/stuinfo/noJobStudent/getNoJobstudentById");
					var formData = new FormData();
