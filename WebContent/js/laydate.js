;
! function(a) {
	var b = { path: "", defSkin: "default", format: "YYYY-MM-DD", min: "1600-01-01 00:00:00", max: "2099-12-31 23:59:59", isv: !1 },
		c = {},
		d = document,
		e = "createElement",
		f = "getElementById",
	...
	a.laydate = function(b) { b = b || {}; try { a.event = a.event || laydate.caller.arguments[0] } catch(d) {} return a.event && (b.tagName = 1), c.run(b), laydate }, laydate.v = "1.1", c.getPath = function() {
