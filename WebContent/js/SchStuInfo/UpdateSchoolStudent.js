				...
				buttons : {
					'提交修改' : {
						...
						action : function() {
							...
							formData
									.append(
											"stuinfoStuBaseinfo.stu_password",
											document
													.getElementById("stu_password_modify").value);
							formData
									.append(
							...
							xhr
									.open("POST",
											"/stuinfo/schoolStudent/updateSchoolStuById");
							...
							if (xhr.status == 200) {
								...
								if (schoolStudentListById[0].stuinfoStuBaseinfo.stu_id == thisStudentInfo.id) {
									...
									new_tr_1.innerHTML = '<td>学号：</td>'
											...
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_account
											+ '"></td>'
											+ '<td><input class="form-control  " type="hidden" id="stu_id_modify"  value="'
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_id
											+ '"><input class="form-control  " type="hidden" id="stu_password_modify"  value="'
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_password
											+ '"></td>'
									...
									new_tr_1.innerHTML = '<td>性别：</td>'
											...
											+ '<option value="'
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_sex
											...
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_adress
											+ '" ></td>'
									var select = document
									...
									new_tr_1.innerHTML = '<td>出生年月：</td>'
											...
											+ '<option value="'
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_familytype
									...
									new_tr_1.innerHTML = '<td>民族：</td>'
											...
											+ '<option value="'
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_policits
									...
									new_tr_1.innerHTML = '<td>证件号码：</td>'
											...
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_idcard
											+ '"></td>'
											+ '<td>本人联系电话：</td>'
											+ '<input class="form-control  " id="stu_phenumber_modify" type="text" value="'
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_phenumber
											+ '" >'
									...
									new_tr_1.innerHTML = '<td>父亲姓名：</td>'
											...
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_fathername
											+ '"></td>'
											+ '<td>父亲联系电话：</td>'
											+ '<input class="form-control  " id="stu_fathernum_modify" type="text" value="'
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_fathernum
											+ '" >'
									...
									new_tr_1.innerHTML = '<td>母亲姓名：</td>'
											...
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_mothername
											+ '"></td>'
											+ '<td>母亲联系电话：</td>'
											+ '<input class="form-control  " id="stu_mothernum_modify" type="text" value="'
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_mothernum
											+ '" >'
									...
									new_tr_1.innerHTML = '<td>层次：</td>'
											...
											+ '<option value="'
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_lev
											...
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_college
											+ '" ></td>'
									var select = document
									...
									new_tr_1.innerHTML = '<td>学院：</td>'
											...
											+ '<option value="'
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_major
									...
									for (var num1 = 0; num1 < classList.length; num1++) {
										...
										if (option.value == schoolStudentListById[0].stuinfoStuGrade.stu_grade_id) {
										...
										if (option.value == schoolStudentListById[0].stuinfoStuGrade.stu_class_id) {
											option.selected = "selected";
										}
									}
									...
									new_tr_1.innerHTML = '<td>学制：</td>'
											...
											+ '<option value="'
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_year
											...
											+ schoolStudentListById[0].stuinfoStuBaseinfo.stu_change
											+ '" ></td>'
